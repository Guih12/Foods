module PlaceOrder
  class Record < ApplicationRecord
    self.table_name = "place_orders"
    belongs_to :user
    belongs_to :restaurant, class_name: "Restaurant::Record"
  
    has_many :place_order_combo_items, class_name: "PlaceOrder::Combo::Item::Record", foreign_key: 'place_order_id'
    has_many :place_order_product_items, class_name: "PlaceOrder::Product::Item::Record", foreign_key: 'place_order_id'
